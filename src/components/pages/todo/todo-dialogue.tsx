...
export default function ToDoDialog({
  ...
  const removeChecklistItem = (index: number) => {
    setValue("checklist", checklist.filter((_, i) => i !== index));
  };
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="bg-background text-foreground max-h-[90vh] overflow-y-auto overflow-x-hidden max-w-4xl hide-scrollbar-on-main">
        <DialogHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-2 md:gap-5">
              ...
              <div className="space-y-2 md:col-span-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  {/* Minute */}
                  <Select
                    value={watch("dueTime")?.split(":")[1]?.split(" ")[0] || ""}
                    onValueChange={(v) =>
                      setValue(
                        "dueTime",
