  ...
  return (
    <section ref={containerRef} className="py-40 bg-[#0A0A0A] relative overflow-hidden min-h-[120vh] flex items-center">
      ...
      <div className="container mx-auto px-6 relative z-10 w-full">
        ...
        <motion.div style={{ y: y1 }} className="absolute -left-10 top-0 text-[#ff6a00]/20 font-[family-name:var(--font-heading)] text-5xl font-bold -rotate-12 pointer-events-none">
        ...
        <div className="relative h-[800px] w-full max-w-6xl mx-auto perspective-[2000px]">
          ...
          <motion.div
            ...
            className="absolute top-10 right-[10%] w-[500px] h-[350px] bg-white/5 border border-white/10 rounded-[40px] backdrop-blur-sm shadow-2xl p-8 z-10 flex flex-col gap-4"
          >
          ...
          <motion.div
            style={{ y: y2, z: 100 }}
            className="absolute top-[30%] left-[5%] w-[450px] h-[400px] bg-white/10 border border-white/20 rounded-[40px] backdrop-blur-md shadow-[0_30px_60px_rgba(0,0,0,0.5)] p-8 z-20 flex flex-col gap-6 rotate-3"
          >
          ...
          <motion.div
            ...
            className="absolute bottom-0 right-[15%] w-[400px] h-[300px] bg-black/60 border border-[#ff6a00]/30 rounded-[40px] backdrop-blur-2xl shadow-[0_50px_100px_rgba(255,106,0,0.2)] p-8 z-30 -rotate-6 flex flex-col"
          >
