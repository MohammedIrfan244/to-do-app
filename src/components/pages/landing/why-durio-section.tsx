    ...
    <section ref={containerRef} className="py-40 bg-[#0A0A0A] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-20">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-black font-[family-name:var(--font-heading)] text-white tracking-tighter leading-none">
            Your life isn't scattered.<br />
            <span className="text-muted-foreground italic text-4xl md:text-6xl">Your apps are.</span>
          </h2>
          <p className="text-xl font-[family-name:var(--font-body)] text-muted-foreground max-w-lg leading-relaxed">
        ...
        <div className="flex-1 w-full relative h-[600px]">
          ...
          <motion.div
            ...
            className="absolute top-[10%] right-[20%] w-24 h-24 bg-pink-500/10 border border-pink-500/30 backdrop-blur-xl rounded-3xl flex items-center justify-center shadow-2xl"
          >
          ...
          <motion.div
            style={{ y: y2, x: x1 }}
            className="absolute bottom-[20%] left-[10%] w-32 h-32 bg-blue-500/10 border border-blue-500/30 backdrop-blur-xl rounded-[2rem] flex items-center justify-center shadow-2xl"
          >
          ...
          <motion.div
            ...
            className="absolute top-[40%] left-[0%] w-20 h-20 bg-yellow-500/10 border border-yellow-500/30 backdrop-blur-xl rounded-2xl flex items-center justify-center shadow-2xl"
          >
          ...
          <motion.div
            ...
            className="absolute bottom-[40%] right-[5%] w-28 h-28 bg-indigo-500/10 border border-indigo-500/30 backdrop-blur-xl rounded-3xl flex items-center justify-center shadow-2xl"
          >
