...
export function AndroidSection() {
  ...
  return (
    <section id="android" ref={containerRef} className="py-24 sm:py-40 bg-black relative z-20 overflow-x-clip overflow-y-visible">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        ...
        {/* Scattered Phones */}
        <div className="hidden lg:block flex-1 relative h-[700px] w-full perspective-[2000px]">
           {/* Phone 1 */}
           <motion.div
             ...
             className="absolute top-[10%] right-[40%] w-[240px] sm:w-[260px] md:w-[290px] aspect-[9/19] rounded-[40px] border-[8px] border-white/20 overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] bg-black z-10 cursor-pointer"
           >
             <img 
                src={images.mobile1}
           ...
           <motion.div
             ...
             className="absolute top-[20%] right-[10%] w-[260px] sm:w-[300px] md:w-[320px] aspect-[9/19] rounded-[40px] border-[10px] border-[#ff6a00]/40 overflow-hidden shadow-[0_30px_80px_rgba(255,106,0,0.3)] bg-black z-20 cursor-pointer"
           >
             <img 
                src={images.mobile3}
           ...
           <motion.div
             ...
             className="absolute bottom-[10%] right-[30%] w-[210px] sm:w-[240px] md:w-[260px] aspect-[9/19] rounded-[30px] border-[6px] border-white/10 overflow-hidden shadow-2xl bg-black z-30 cursor-pointer"
           >
             <img 
                src={images.mobile2}
        ...
        <div className="lg:hidden grid w-full max-w-[480px] gap-4">
          <div className="rounded-[32px] border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
            <img src={images.mobile1} alt="Android preview" className="h-72 w-full rounded-[24px] object-cover" />
          </div>
          <div className="rounded-[32px] border border-[#ff6a00]/30 bg-[#ff6a00]/10 p-4 backdrop-blur-md">
            <img src={images.mobile3} alt="Android preview" className="h-72 w-full rounded-[24px] object-cover" />
          </div>
          <div className="rounded-[32px] border border-white/10 bg-black/60 p-4 backdrop-blur-sm">
            <img src={images.mobile2} alt="Android preview" className="h-72 w-full rounded-[24px] object-cover" />
          </div>
        </div>
