  ...
  return (
    ...
    `}>
      <div className="relative flex flex-col items-center gap-4 animate-in fade-in zoom-in duration-300">
        ...
        {/* Loading Text */}
        <p className={`text-lg font-medium animate-pulse ${targetTheme === 'gothic' ? 'text-purple-200' : 'text-foreground/80'}`}>
          Applying {targetTheme ? targetTheme.charAt(0).toUpperCase() + targetTheme.slice(1) : 'System'} Theme...
        </p>
      </div>
    </div>
  )
